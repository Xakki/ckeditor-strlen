/*
* Copyright (c) 2011, http://xakki.ru
* Плагин показывает число симовлов набранные в редакторе (учитываются также и теги) 
* и если  у textarea установлен атрибут maxlength, то показывает максимально допустимое значение.
* TODO : Планируется сделать опциональное ограничение по максимальному числу символов (запрет на добавление символа если достигнут лимит)
*/
...
(function()
{
	...
	CKEDITOR.plugins.add( 'strlen',
	{
		init : function( editor )
		{
			var spaceId = 'cke_strlen_' + editor.name;
			var spaceElement;
			var maxi;
